...
def insertBindingAffinity(db_file, binding_dataset, drugId, smiles, inChiKey, upId, Kd, Ki, IC50, pH, Temperature, Organism, Source):
    """Insert values for BindingReactionID, Kd_min, Kd_max, Ki_min, Ki_max, IC50_min, IC50_max, pH, Temperature, Organism and Source to BindingAffinity table.
...
def insertSingleBindingAffinity(db_file, drugID, hgnc, Source, Kd_min = None, Kd_max = None, Ki_min = None, Ki_max = None, ic50_min = None, ic50_max = None, pH = None, temp = None, Organism = None):
    """Insert values for BindingReactionID, Kd_min, Kd_max, Ki_min, Ki_max, IC50_min, IC50_max, pH, Temperature, Organism and Source to BindingAffinity table.
    Write HGNC, DrugID, BindingReactionID to MeasuredFor table.
    :param db_file: database db_file, drugID: ChEMBL id for drug, HGNC: HGNC symbol for target, Kd_min: min value for measured Kd, Kd_max: max value for measured Kd, Ki_min: min value for measured Ki, Ki_max: max value for measured Ki, 
                    ic50_min: min value for measured IC50, ic50_max: max value for measured IC50,
                    pH: pH value used in the measurement, Temperature: temp used in the measurement, Organism: organism the measurement is executed on, Source: DOI for article that provide the measurement"""
